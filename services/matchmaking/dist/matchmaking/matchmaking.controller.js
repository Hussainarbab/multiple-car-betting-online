...
let MatchmakingController = class MatchmakingController {
    ...
    async joinQueue(body) {
        const matchId = await this.matchmakingService.joinQueue(body.userId, body.wagerAmount, body.skillRange);
        return { matchId };
    }
...
__decorate([
    (0, common_1.Get)('status/:matchId'),
    __param(0, (0, common_1.Param)('matchId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], MatchmakingController.prototype, "getMatchStatus", null);
